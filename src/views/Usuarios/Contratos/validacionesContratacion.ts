...
export const crearContratoSchema = z.object({
    ...
    clave_catastral: z.string().min(10,"Ingresa la clave catastral o ingresa mínimo 10 caracteres").max(14, "Deben ser maximo 12 caracteres"),
    tipo_toma: z.number().min(1,"Ingresa tipo de toma"),
    num_casa: z.string().min(1,"Ingresa el número de casa"),
    colonia: z.number(),
    ...
    c_alc: z.boolean(),
    c_san: z.boolean(),
    tipo_contratacion: z.string().min(1,"Ingresa el tipo de contratación"),
