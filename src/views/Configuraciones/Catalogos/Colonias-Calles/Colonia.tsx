    ...
    <ContextProvider>
      <div className='w-full '>
        ...
        <div className='flex gap-2 '>
          ...
          {/*Formulario*/}
          <div className='w-full rounded-md border border-border max-h-[77vh] p-4 overflow-auto'>
...
const ColoniaFormEdit = () => {
  ...
  return (
    <>
      ...
      {accion == "editar" ? (<div className='w-full rounded-md border border-primary h-full p-4  overflow-auto'>
            <ColoniaForm /> 
          </div>) : (<div className='w-full rounded-md border border-border h-full p-4 overflow-auto '>
            <ColoniaForm />
          </div>)}
    </>
  );
