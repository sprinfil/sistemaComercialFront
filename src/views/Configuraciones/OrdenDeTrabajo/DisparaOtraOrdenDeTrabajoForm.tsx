...
import { OrdenesDeTrabajoComboBox } from "../../../components/ui/OrdenesDeTrabajoComboBox.tsx";
                            ...
                            <div className="flex space-x-10">
                                <div className="w-full">
                                    <FormField
                                        ...
                                        name={`id_OT_Catalogo_encadenada${item.id}`} // Nombre único por índice
                                        render={({ field }) => (
                                            <FormItem>
                                                <FormLabel>Agregar orden de trabajo</FormLabel>
                                                <FormControl>
                                                    <>
                                                    ...
                                                    <div className="w-full">
                                                    <OrdenesDeTrabajoComboBox form={form} field={field} name={`id_OT_Catalogo_encadenada${item.id}`} setCargoSeleccionado={setConceptoSeleccionado} />
