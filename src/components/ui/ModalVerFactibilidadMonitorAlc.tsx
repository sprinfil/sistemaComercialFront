...
const ModalVerFactibilidadMonitorAlc = ({ selected_fact, open, set_open }) => {
  ...
  const handleUpdate = async (newEstado) => {
    ...
    try {
      ...
      formData.append('servicio', 'alcantarillado y saneamiento');
...
export default ModalVerFactibilidadMonitorAlc;
